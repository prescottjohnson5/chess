...
public class ChessClient {
    ...
    private void playGameUi() {
        ...
        try {
            ...
            new GameplayUi(scanner, gson, wsHost, wsPort, () -> auth.authToken()).run(selected.gameID(), team);
        } catch (ServerFacadeException e) {
            System.out.println(e.getMessage());
        }
    }
    ...
    private void observeGameUi() {
        ...
        new GameplayUi(scanner, gson, wsHost, wsPort, () -> auth.authToken()).run(
                selected.gameID(), ChessGame.TeamColor.WHITE);
    }
